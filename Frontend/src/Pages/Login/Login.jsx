    ...
    return (
        <div className='login'>
            ...
            <form onSubmit={onSubmitHandler} className='login-form'>
                ...
                {currentstate === "Sign Up" ? <div className="login-forget">
                    <p className='login-forget-text'>Already have an account? <span onClick={() => { setcurrentstate("Login") }}>Click Here</span></p>
                </div> : <div className="login-forget">
                    <p className='login-forget-text'>Don't have an account? <span onClick={() => { setcurrentstate("Sign Up") }}>Click Here</span></p></div>
